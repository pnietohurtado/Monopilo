...
public class VersionfinalHilo {
    ...
    public static String menuJugador(){
        ...
        System.out.println(" [5] Intercambio con Jugador. ");
   ...
   public static void resetearJugador(String[][] tablero) {
        ...
        public void run() {
            try{
                   ...
                   */
                   ...
                   //QUIERO EMPEZAR A REPETIR DESDE AQUÍ 
                   synchronized(this){
                            ...
                            //System.out.println("eleccion "+eleccion);
                                ...
                                if(carcelJ1 == 0){
                                    switch(eleccionJ1){
                                        ...
                                        case "5": 
                                            /*Vamos a ver las casillas disponibles de ambos jugadores y vamos a tener que 
                                            comprobar que el el valor por el que las van a intercambiar sea coherente y 
                                            se lo puedan permitir realmente. */
                                        {
    ...
    public static void main(String[] args)throws SQLException, Exception {
        ...
        Thread.sleep(30000); 
        System.out.println("Pausando un momentin....");
        h.pausar();
        Thread.sleep(4000); 
        h.reanudar();
